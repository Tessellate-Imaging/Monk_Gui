...
analysis_name = system["analysis"]["freeze_layer"]["analysis_name"];

   
freeze_layers = system["analysis"]["freeze_layer"]["list"].split(",");
freeze_layers = list(map(int, freeze_layers))



epochs=int(system["analysis"]["freeze_layer"]["epochs"]);


percent_data=int(system["analysis"]["freeze_layer"]["percent"]);

 
analysis = ptf.Analyse_Freeze_Layers(analysis_name, 
                                    freeze_layers, 
                                    percent_data, 
                                    num_epochs=epochs, 
                                    state="keep_none"); 
