...
analysis_name = system["analysis"]["freeze_base"]["analysis_name"];
if(system["update"]["model_name"]["active"]):
...
tmp_list = system["analysis"]["freeze_base"]["list"].split(",");
model_lists = [[model_name, True, True], [model_name, False, True]];


epochs=int(system["analysis"]["freeze_base"]["epochs"]);


percent_data=int(system["analysis"]["freeze_base"]["percent"]);
