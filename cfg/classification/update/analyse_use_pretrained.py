...
analysis_name = system["analysis"]["use_pretrained"]["analysis_name"];
if(system["update"]["model_name"]["active"]):
    model_name = system["update"]["model_name"]["value"];
else:
    model_name = system["model"];

   
tmp_list = system["analysis"]["use_pretrained"]["list"].split(",");
model_lists = [[model_name, True, True], [model_name, True, False]];


epochs=int(system["analysis"]["use_pretrained"]["epochs"]);


percent_data=int(system["analysis"]["use_pretrained"]["percent"]);
