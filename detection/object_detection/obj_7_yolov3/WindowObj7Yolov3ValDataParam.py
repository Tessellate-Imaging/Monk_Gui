...
class WindowObj7Yolov3ValDataParam(QtWidgets.QWidget):

    backward_7_yolov3_data_preproc = QtCore.pyqtSignal();
    forward_model_param = QtCore.pyqtSignal();

    def __init__(self):
        super().__init__()
        self.title = 'Yolo V3 - Validation Data Param'
        self.left = 10
        self.top = 10
        self.width = 900
        self.height = 600
    ...
    def initUI(self):
        ...
        if self.system["val_anno_type"] == "yolo":
            self.r4.setChecked(True)
        self.r4.move(790,60)
        self.r4.toggled.connect(self.yolo);
        self.wid.append(self.r4);
    ...
    def val(self):
        ...
        if(use_val == "yes"):
            ...
            if self.system["val_anno_type"] == "monk":
                ...
                self.voc();
            elif self.system["val_anno_type"] == "cooc":
                self.coco();
            else:
                self.yolo();
    ...
    def select_root_dataset(self):
        ...
        if self.r4.isChecked():
            ...
            self.system["yolo_coco_root_dir"] = folderName;
    ...
    def select_img_dir(self):
        ...
        if self.r4.isChecked():
            ...
            self.system["val_yolo_img_dir"] = folderName;
    ...
    def select_yolo_anno_dir(self):
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        folderName = QFileDialog.getExistingDirectory(self,"QFileDialog.getExistingDirectory()", self.system["val_yolo_root_dir"])
        folderName = folderName.split("/")[-1];
        self.y_b3.setText("Selected");
        self.y_tb3.setText(folderName);
        self.system["val_yolo_anno_dir"] = folderName;
    ...
    def select_yolo_classes_file(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(self,"QFileDialog.getOpenFileName()", os.getcwd(), 
                                                    ...
                                                    options=options)
        fileName = fileName.split("/")[-1];
        self.system["val_yolo_classes_file"] = fileName;
    ...
    def forward(self):
        if self.r1.isChecked():
            ...
            self.system["val_anno_type"] = "yolo";
    ...
    def backward(self):
        ...
        self.backward_7_yolov3_data_preproc.emit();
...
screen = WindowObj7Yolov3ValDataParam()
screen.show()
sys.exit(app.exec_())
'''
