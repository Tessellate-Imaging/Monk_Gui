...
class WindowObj7Yolov3(QtWidgets.QWidget):
    ...
    def install(self):
        ...
        if(self.cb4.currentText() == "Cuda"):
            os.system("cp cfg/detection/object_detection/obj_7_yolov3/install_obj_7_yolov3_cuda.sh .");
            os.system("chmod +x install_obj_7_yolov3_cuda.sh");
            self.process.start('bash', ['install_obj_7_yolov3_cuda.sh'])
