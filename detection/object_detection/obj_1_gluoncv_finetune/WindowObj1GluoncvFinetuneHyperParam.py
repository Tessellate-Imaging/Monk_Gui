...
class WindowObj1GluoncvFinetuneHyperParam(QtWidgets.QWidget):

    backward_model_model_param = QtCore.pyqtSignal();
    forward_train = QtCore.pyqtSignal();

    def __init__(self):
        super().__init__()
        self.title = 'GluonCV Finetune - Hyper Param'
        self.left = 100
        self.top = 100
        self.width = 500
        self.height = 220
    ...
    def backward(self):
        ...
        self.backward_model_model_param.emit();


'''
app = QApplication(sys.argv)
screen = WindowObj1GluoncvFinetuneHyperParam()
screen.show()
sys.exit(app.exec_())
'''