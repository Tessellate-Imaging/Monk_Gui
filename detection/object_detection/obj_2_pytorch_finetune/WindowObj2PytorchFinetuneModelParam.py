...
class WindowObj2PytorchFinetuneModelParam(QtWidgets.QWidget):

    backward_2_pytorch_finetune_valdata_param = QtCore.pyqtSignal();
    forward_hyper_param = QtCore.pyqtSignal();

    def __init__(self):
        super().__init__()
        self.title = 'Pytorch Finetune - Model Param'
        self.left = 100
        self.top = 100
        self.width = 500
        self.height = 400
    ...
    def initUI(self):
        ...
        self.l4 = QLabel(self);
        self.l4.setText("  (Multi-GPU feature not enabled)");
        self.l4.move(20, 170);
    ...
    def backward(self):
        ...
        self.backward_2_pytorch_finetune_valdata_param.emit();


'''
app = QApplication(sys.argv)
screen = WindowObj2PytorchFinetuneModelParam()
screen.show()
sys.exit(app.exec_())
'''