...
class WindowObj6CornernetLite(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'Object Detection - Cornernet-Lite'
        self.left = 100
        self.top = 100
        self.width = 800
        self.height = 600
    ...
    def install(self):
        ...
        if(self.cb4.currentText() == "Cuda"):
            os.system("cp cfg/detection/object_detection/obj_6_cornernet_lite/install_obj_6_cornernet_lite_cuda.sh .");
            os.system("chmod +x install_obj_6_cornernet_lite_cuda.sh");
            self.process.start('bash', ['install_obj_6_cornernet_lite_cuda.sh'])
...
screen = WindowObj6CornernetLite()
screen.show()
sys.exit(app.exec_())
'''
