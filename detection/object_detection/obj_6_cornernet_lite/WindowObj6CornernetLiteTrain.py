...
class WindowObj6CornernetLiteTrain(QtWidgets.QWidget):

    backward_hyper_param = QtCore.pyqtSignal();
    forward_6_cornernet_lite = QtCore.pyqtSignal(); 
    ...
    def initUI(self):
        ...
        self.l1 = QLabel(self);
        self.l1.setText("Num Iterations: ");
        self.l1.move(20, 300);

        self.e1 = QLineEdit(self)
        self.e1.move(150, 300);
        self.e1.setText(self.system["iterations"]);
        self.e1.resize(200, 25);



        self.l3 = QLabel(self);
        self.l3.setText("Val interval (iterations): ");
        self.l3.move(20, 350);
    ...
    def train(self):
        ...
        self.system["iterations"] = self.e1.text();
        ...
        os.system("cp cfg/detection/object_detection/obj_6_cornernet_lite/train_obj_6_cornernet_lite.py .");
        os.system("cp cfg/detection/object_detection/obj_6_cornernet_lite/train_obj_6_cornernet_lite.sh .");


        self.process.start('bash', ['train_obj_6_cornernet_lite.sh'])
    ...
    def forward(self):
        ...
        self.forward_6_cornernet_lite.emit();
...
screen = WindowObj6CornernetLiteTrain()
screen.show()
sys.exit(app.exec_())
'''