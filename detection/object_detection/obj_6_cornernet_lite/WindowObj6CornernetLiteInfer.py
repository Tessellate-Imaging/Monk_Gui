...
class WindowObj6CornernetLiteInfer(QtWidgets.QWidget):

    backward_6_cornernet_lite = QtCore.pyqtSignal();



    def __init__(self):
        super().__init__()
        self.title = 'Cornernet Lite - Infer'
        self.left = 100
        self.top = 100
        self.width = 900
        self.height = 600
    ...
    def cfg_setup(self):
        if(os.path.isfile("obj_6_cornernet_lite_infer.json")):
            with open('obj_6_cornernet_lite_infer.json') as json_file:
                self.system = json.load(json_file)
        else:
            self.system = {};
            self.system["model"] = "CornerNet_Saccade";
            self.system["weights"] = "cache/nnet/CornerNet_Saccade/CornerNet_Saccade_final.pkl";
            ...
            with open('obj_6_cornernet_lite_infer.json', 'w') as outfile:
    ...
    def initUI(self):
        ...
        self.cb2.activated.connect(self.set_weight_file)
    ...
    def set_weight_file(self):
        self.system["model"] = self.cb2.currentText();
        self.system["weights"] = "cache/nnet/" + self.system["model"] + "/" + self.system["model"] + "_final.pkl"
        self.tb2.setText(self.system["weights"]);
    ...
    def Predict(self):
        ...
        os.system("cp cfg/detection/object_detection/obj_6_cornernet_lite/infer_obj_6_cornernet_lite.py .");
        os.system("cp cfg/detection/object_detection/obj_6_cornernet_lite/infer_obj_6_cornernet_lite.sh .");

        self.process.start('bash', ['infer_obj_6_cornernet_lite.sh'])
    ...
    def backward(self):
        ...
        with open('obj_6_cornernet_lite_infer.json', 'w') as outfile:
            json.dump(self.system, outfile)
        self.backward_6_cornernet_lite.emit();



'''
app = QApplication(sys.argv)
screen = WindowObj6CornernetLiteInfer()
screen.show()
sys.exit(app.exec_())
'''