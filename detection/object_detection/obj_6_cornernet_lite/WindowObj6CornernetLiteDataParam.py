...
class WindowObj6CornernetLiteDataParam(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'Cornernet Lite - Training Data Param'
        self.left = 10
        self.top = 10
        self.width = 800
        self.height = 600
    ...
    def cfg_setup(self):
        if(os.path.isfile("obj_6_cornernet_lite.json")):
            ...
            self.system["lr"] = "0.00025";
            self.system["val_interval"] = "200";
            self.system["print_interval"] = "100";
            self.system["iterations"] = "1000";
...
screen = WindowObj6CornernetLiteDataParam()
screen.show()
sys.exit(app.exec_())
'''
