...
class WindowObj3Mxrcnn(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'Object Detection - MXRcnn'
        self.left = 100
        self.top = 100
        self.width = 800
        self.height = 600
    ...
    def initUI(self):
        ...
        self.cudas = ["Cuda-9.0", "Cuda-9.2", "Cuda-10.0", "Cuda-10.1"];
    ...
    def install(self):
        ...
        if(self.cb4.currentText() == "Cuda-9.0"):
            os.system("cp cfg/detection/object_detection/obj_3_mxrcnn/install_obj_3_mxrcnn_cuda90.sh .");
            os.system("chmod +x install_obj_3_mxrcnn_cuda90.sh");
            self.process.start('bash', ['install_obj_3_mxrcnn_cuda90.sh'])
            self.append("Process PID: " + str(self.process.pid()) + "\n");
        elif(self.cb4.currentText() == "Cuda-9.2"):
            os.system("cp cfg/detection/object_detection/obj_3_mxrcnn/install_obj_3_mxrcnn_cuda92.sh .");
            os.system("chmod +x install_obj_3_mxrcnn_cuda92.sh");
            self.process.start('bash', ['install_obj_3_mxrcnn_cuda92.sh'])
            self.append("Process PID: " + str(self.process.pid()) + "\n");
        elif(self.cb4.currentText() == "Cuda-10.0"):
            os.system("cp cfg/detection/object_detection/obj_3_mxrcnn/install_obj_3_mxrcnn_cuda10.sh .");
            os.system("chmod +x install_obj_3_mxrcnn_cuda10.sh");
            self.process.start('bash', ['install_obj_3_mxrcnn_cuda10.sh'])
            self.append("Process PID: " + str(self.process.pid()) + "\n");
        elif(self.cb4.currentText() == "Cuda-10.1"):
            os.system("cp cfg/detection/object_detection/obj_3_mxrcnn/install_obj_3_mxrcnn_cuda101.sh .");
            os.system("chmod +x install_obj_3_mxrcnn_cuda101.sh");
            self.process.start('bash', ['install_obj_3_mxrcnn_cuda101.sh'])
            self.append("Process PID: " + str(self.process.pid()) + "\n");
