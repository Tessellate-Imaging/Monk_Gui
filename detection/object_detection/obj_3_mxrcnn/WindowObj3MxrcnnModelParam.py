...
class WindowObj3MxrcnnModelParam(QtWidgets.QWidget):

    backward_3_mxrcnn_data_preproc = QtCore.pyqtSignal();
    forward_hyper_param = QtCore.pyqtSignal();

    def __init__(self):
        super().__init__()
        self.title = 'Mxrcnn - Model Param'
        self.left = 100
        self.top = 100
        self.width = 500
        self.height = 400
    ...
    def backward(self):
        ...
        self.backward_3_mxrcnn_data_preproc.emit();


'''
app = QApplication(sys.argv)
screen = WindowObj3MxrcnnModelParam()
screen.show()
sys.exit(app.exec_())
'''