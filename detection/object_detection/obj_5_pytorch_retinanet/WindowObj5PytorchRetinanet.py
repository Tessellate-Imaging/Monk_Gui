...
class WindowObj5PytorchRetinanet(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'Object Detection - Pytorch Retinanet'
        self.left = 100
        self.top = 100
        self.width = 800
        self.height = 600
    ...
    def install(self):
        ...
        if(self.cb4.currentText() == "Cuda"):
            os.system("cp cfg/detection/object_detection/obj_5_pytorch_retinanet/install_obj_5_pytorch_retinanet_cuda.sh .");
            os.system("chmod +x install_obj_5_pytorch_retinanet_cuda.sh");
            self.process.start('bash', ['install_obj_5_pytorch_retinanet_cuda.sh'])
