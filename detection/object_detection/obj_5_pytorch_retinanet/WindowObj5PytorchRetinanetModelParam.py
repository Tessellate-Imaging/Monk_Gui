...
class WindowObj5PytorchRetinanetModelParam(QtWidgets.QWidget):

    backward_5_pytorch_retinanet_valdata_param = QtCore.pyqtSignal();
    forward_hyper_param = QtCore.pyqtSignal();

    def __init__(self):
        super().__init__()
        self.title = 'Pytorch Retinanet - Model Param'
        self.left = 100
        self.top = 100
        self.width = 500
        self.height = 400
    ...
    def initUI(self):
        ...
        self.models = ["resnet18", "resnet34", "resnet50", "resnet101", "resnet152"];
    ...
    def backward(self):
        ...
        self.backward_5_pytorch_retinanet_valdata_param.emit();


'''
app = QApplication(sys.argv)
screen = WindowObj5PytorchRetinanetModelParam()
screen.show()
sys.exit(app.exec_())
'''