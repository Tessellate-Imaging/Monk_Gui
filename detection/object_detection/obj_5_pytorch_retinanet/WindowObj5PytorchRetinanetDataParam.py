...
class WindowObj5PytorchRetinanetDataParam(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'Pytorch Retinanet - Training Data Param'
        self.left = 10
        self.top = 10
        self.width = 800
        self.height = 600
...
screen = WindowObj5PytorchRetinanetDataParam()
screen.show()
sys.exit(app.exec_())
'''
