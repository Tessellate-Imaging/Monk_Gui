...
class WindowClassificationInferUpdate(QtWidgets.QWidget):
    ...
    def predict(self):
        ...
        if self.system["datatype"] == "image" and self.system["labeltype"] == "single":
            os.system("cp cfg/classification/update/infer_cls_image_single.py .");
            os.system("cp cfg/classification/update/infer_cls_image_single.sh .");
...
screen = WindowClassificationInferUpdate()
screen.show()
sys.exit(app.exec_())
'''