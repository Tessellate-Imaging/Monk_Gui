...
class WindowClassificationValidateQuick(QtWidgets.QWidget):
    ...
    def predict(self):
        ...
        if self.system["datatype"] == "image" and self.system["labeltype"] == "single":
            os.system("cp cfg/classification/quick/evaluate_cls_image_single.py .");
            os.system("cp cfg/classification/quick/evaluate_cls_image_single.sh .");
...
screen = WindowClassificationValidateQuick()
screen.show()
sys.exit(app.exec_())
'''