...
class WindowClassificationTrainQuickTrain(QtWidgets.QWidget):
    ...
    def train(self):
        ...
        if(self.move_ahead):
            ...
            if self.system["datatype"] == "image" and self.system["labeltype"] == "single":
                os.system("cp cfg/classification/quick/train_cls_image_single.py .");
                os.system("cp cfg/classification/quick/train_cls_image_single.sh .");
    ...
    def resume(self):
        ...
        if(self.move_ahead):
            ...
            if self.system["datatype"] == "image" and self.system["labeltype"] == "single":
                os.system("cp cfg/classification/quick/resume_cls_image_single.py .");
                os.system("cp cfg/classification/quick/resume_cls_image_single.sh .");
...
screen = WindowClassificationTrainQuickTrain()
screen.show()
sys.exit(app.exec_())
'''