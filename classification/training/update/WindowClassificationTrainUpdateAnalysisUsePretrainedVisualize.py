...
class WindowClassificationTrainUpdateAnalysisUsePretrainedVisualize(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.cfg_setup()
        self.title = 'Experiment {} - Visualize Analysis of Using pretrained weights Hyperparam tuning'.format(self.system["experiment"])
        self.left = 10
        self.top = 10
        self.width = 900
        self.height = 600
    ...
    def cfg_setup(self):
        ...
        self.comparison_name = "Comparison_" + self.system["analysis"]["use_ptretrained"]["analysis_name"]
...
screen = WindowClassificationTrainUpdateAnalysisUsePretrainedVisualize()
screen.show()
sys.exit(app.exec_())
'''