...
class WindowClassificationTrainUpdateAnalysisOptimizerLrVisualize(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.cfg_setup()
        self.title = 'Experiment {} - Visualize Analysis of optimizers and learning rates Hyperparam tuning'.format(self.system["experiment"])
        self.left = 10
        self.top = 10
        self.width = 900
        self.height = 600
    ...
    def cfg_setup(self):
        ...
        self.comparison_name = "Comparison_" + self.system["analysis"]["optimizer_lr"]["analysis_name"]
...
screen = WindowClassificationTrainUpdateAnalysisOptimizerLrVisualize()
screen.show()
sys.exit(app.exec_())
'''