...
class WindowClassificationTrainUpdateAnalysisFreezeLayerVisualize(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.cfg_setup()
        self.title = 'Experiment {} - Visualize Analysis of freezing layers in network'.format(self.system["experiment"])
        self.left = 10
        self.top = 10
        self.width = 900
        self.height = 600
    ...
    def cfg_setup(self):
        ...
        self.comparison_name = "Comparison_" + self.system["analysis"]["freeze_layer"]["analysis_name"]
...
screen = WindowClassificationTrainUpdateAnalysisFreezeLayerVisualize()
screen.show()
sys.exit(app.exec_())
'''