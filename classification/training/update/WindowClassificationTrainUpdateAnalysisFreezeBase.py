...
class WindowClassificationTrainUpdateAnalysisFreezeBase(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.cfg_setup()
        self.title = 'Experiment {} - Analyse Models freeze base network'.format(self.system["experiment"])
        self.left = 10
        self.top = 10
        self.width = 900
        self.height = 600
    ...
    def initUI(self):
        ...
        self.e1.setText(self.system["analysis"]["freeze_base"]["analysis_name"]);
        ...
        self.e2.move(570, 20);
        self.e2.setText(self.system["analysis"]["freeze_base"]["percent"]);



        self.l3 = QLabel(self);
        self.l3.setText("3. Freeze base network:");
        self.l3.move(20, 70);
        ...
        self.e4.move(570, 70);
        self.e4.setText(self.system["analysis"]["freeze_base"]["epochs"]);
        ...
        self.te1.setText(self.system["analysis"]["freeze_base"]["analysis"]);
    ...
    def start(self):
        ...
        self.system["analysis"]["freeze_base"]["analysis_name"] = self.e1.text();
        self.system["analysis"]["freeze_base"]["percent"] = self.e2.text();
        self.system["analysis"]["freeze_base"]["list"] = self.e3.text();
        self.system["analysis"]["freeze_base"]["epochs"] = self.e4.text();

        with open('base_classification.json', 'w') as outfile:
            json.dump(self.system, outfile)

        if self.system["datatype"] == "image" and self.system["labeltype"] == "single":
            os.system("cp cfg/classification/update/analyse_freeze_base.py .");
            os.system("cp cfg/classification/update/analyse_freeze_base.sh .");

        self.process.start('bash', ['analyse_freeze_base.sh'])
    ...
    def stdoutReady(self):
        ...
        self.system["analysis"]["freeze_base"]["analysis"] += text;
        self.append(text)
...
screen = WindowClassificationTrainUpdateAnalysisFreezeBase()
screen.show()
sys.exit(app.exec_())
'''